...
> discussions.
>
> **Essential Concepts** - *Repository (repo)*: The project’s folder on
...
1.  Create a [GitHub](https://github.com/) account if you don’t already
    have one.
...
it unassigned — a team member will review it and take it from there.

### Pull Request workflow

If you’d like to write some code for `Odyssey`, the standard workflow is
as follows:

1.  Check that there isn’t already an issue about your idea in the
    `Odyssey` issues to avoid duplicating work. If there isn’t one
    already, please create one so that others know you’re working on
    this.
...
- If you want to make a bigger change \[such as…\], it’s a good idea to
